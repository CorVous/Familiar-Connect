//! faster-whisper buffer-and-finalize backend (subsystem 09; feature
//! `local-stt`).
//!
//! STUB — intentionally unimplemented. The intended backend runs a CTranslate2
