...
//!
//! Seams (the §4.8): [`Vad`] and [`SmartTurn`] are the two detector traits the
//! endpointer consumes; [`NativeTenVad`] and [`SmartTurnModel`] are the
//! injected native/ONNX handles; [`ModelDownloader`] resolves Smart Turn
//! weights.
