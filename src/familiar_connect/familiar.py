...
class Familiar:
    ...
    """Discord snowflake for logged-in bot user."""
    ...
    emits final ahead of silence timer. ``None`` leaves Deepgram's
    ...
    def load_from_disk(
        ...
        *,
        ...
        defaults_path: override default profile path; tests use to skip
        staging a sibling ``_default/`` folder.
        """
