...
Production wraps Cartesia/Azure/Gemini + Discord voice playback;
tests use :class:`MockTTSPlayer` which records audio duration played
before cancellation.
"""
...
__all__ = ["LoggingTTSPlayer", "MockTTSPlayer", "TTSPlayer"]
