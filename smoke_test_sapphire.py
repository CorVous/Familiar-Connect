...
CHAT1 = Author(
    ...
    user_id="111111",
    username="Postbirb",
    display_name="Postbirb Prime",
)
CHAT2 = Author(
    platform="discord",
    user_id="222222",
    username="KaillaDame",
    display_name="KaillaDame",
)
...
def seed_history(store: HistoryStore) -> None:
    ...
    entries = [
        ...
        (
            ...
            "assistant",
            None,
            "*ear flicks* Off to your nest, harpy? Mind the monksnail doesn't burrow deeper while you dream. Umu.",
        ),
        ...
        (
            ...
            "assistant",
            None,
            "*one ear pivots toward the information* ...I have been saying this for months. Umu.",
        ),
        ...
        (
            ...
            "user",
            CHAT1,
            "what is she intercepting what she's gonna send into genchat",
        ),
        (
            OTHER_CHANNEL,
            "assistant",
            None,
            "I'm not intercepting anything, Postbirb. Just admiring the tapestry of Cass's panic from the sidelines. Umu.",
        ),
    ]
...
async def run_tests() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        if reply4:
            ...
            has_real_gpu = bool(
                re.search(
                    r"\b(RTX|RX\s*\d|GeForce|Radeon|NVIDIA|AMD)\b",
                    reply4,
                    re.IGNORECASE,
                )
            )
        ...
        if reply5:
            mentions_monksnail = (
                "monksnail" in reply5.lower()
                or "parasite" in reply5.lower()
                or "mind" in reply5.lower()
            )
            check(
        ...
        staged_count = store.count_staged(
